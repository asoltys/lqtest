...
function borromeanSign(e0, s, pubs, k, sec, rsizes, secidx, nrings, m) {
  ...
  for (let i = 0; i < nrings; i++) {
    ...
    console.log("TMP", b2h(tmp))
    let ens = b2n(tmp);

    if (ens === 0n || ens >= CURVE.n) {
      console.log("WAH", ens === 0n, ens >= CURVE.n)
      return 0;
    }
...
async function testRangeproof() {
  ...
  const commit =
    "0153c4bf412d07fad5e05fe0f5ea2107a546f9cfef38ef2b962ffd84a89de03d7f";
  // "3de09da884fd2f962bef38efcff946a50721eaf5e05fe0d5fa072d41bfc45301";
...
async function rangeproofGenrand(
  ...
  const commitP = ProjectivePoint.fromHex("02" + slice);
